---
title: "Filtered linear models entire datafile"
...
summary(datafile$UTILIZATION_RATE)

data_trunc <- datafile[datafile$UTILIZATION_RATE > 0.89 & datafile$UTILIZATION_RATE < 0.97, ]
```
